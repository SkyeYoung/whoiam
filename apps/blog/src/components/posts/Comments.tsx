...
export const Comments = () => {
  ...
  return (
    <section className="relative min-h-80">
      <div
        className={clsx(
          'absolute top-0 left-0 z-10 rounded-xl w-full h-full bg-zinc-800/5 flex items-center justify-center text-zinc-600 transition-all duration-300 ease-in-out',
